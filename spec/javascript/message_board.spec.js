...
describe('Comment', () => {
  ...
  describe('avatar owner', () => {
    it('shows message board icon', () => {
      expect(wrapper.html()).toContain("<div><i class=\"fas fa-pen-square message-board-icon\"></i></div>")
    })
  ...
  describe('not owner of avatar', () => {
    ...
    it('does not show message board icon', () => {
      expect(wrapper.html()).not.toContain("<div><i class=\"fas fa-pen-square message-board-icon\"></i></div>")
    })
