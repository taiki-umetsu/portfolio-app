...
describe('Comment', () => {
  ...
  beforeEach(() => {
    ...
    wrapper = mount( Comment,{
      propsData: {
        keyName: 'userShow', index1: 0, item: item
      },
      store, localVue,
  ...
  describe('logged in user', () => {
    ...
    it('does not have link to login in comment icon', () => {
      expect(wrapper.html()).not.toContain("<div><a href=\"/users/sign_in\"><i id=\"avatar-comment\" class=\"far fa-comment\"></i></a></div>")
    })
  ...
  describe('not logged in user', () => {
    ...
    it('has link to login in comment icon', () => {
      expect(wrapper.html()).toContain("<div><a href=\"/users/sign_in\"><i id=\"avatar-comment\" class=\"far fa-comment\"></i></a></div>")
    })
  })
