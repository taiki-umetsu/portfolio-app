  ...
  <div id="comment-field">
    ...
    <div v-for="(list, $index1) in lists" :key="$index1" >
      <div v-for="(item, $index2) in list" :key="$index2">
        ...
        <div class="wrapper-sm shadow-sm" :class="setCommmentId(item['comment_id'])" id="comment-wrap" >
          <div class="container">
            ...
            <div v-show="commentedUser(item['user_id'])" id="icon-delete" @click="deleteComment(item['comment_id'],$index1,$index2)" >
